...
public interface Constants {
    ...
    String ACTION_GATT_CONNECTING = "ACTION_GATT_CONNECTING";
    String ACTION_GATT_CONNECTED = "ACTION_GATT_CONNECTED";
    String ACTION_GATT_DISCONNECTING = "ACTION_GATT_DISCONNECTING";
    String ACTION_GATT_SERVICES_DISCOVERED = "ACTION_GATT_SERVICES_DISCOVERED";
    String ACTION_BLUETOOTH_DEVICE = "ACTION_BLUETOOTH_DEVICE";
    String ACTION_SCAN_FINISHED = "ACTION_SCAN_FINISHED";
